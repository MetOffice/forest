...
class ForestPlot(object):
    ...
    def update_title(self, current_cube):
        ...
        Update plot title.
        '''
        datestr1 = util.get_time_str(current_cube.dim_coords[0].points[self.current_time])
    ...
    def create_bokeh_img_plot_from_fig(self):
        ...
        #try:
        self.current_img_array = util.get_image_array_from_figure(self.current_figure)
        #except:
