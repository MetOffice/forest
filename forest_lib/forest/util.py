...
def create_colour_opts(var_list):
    ...
    col_opts_dict['precip_accum_3hr'] = get_radar_colours()
    col_opts_dict['precip_accum_6hr'] = get_radar_colours()
    col_opts_dict['precip_accum_12hr'] = get_radar_colours()
    col_opts_dict['precip_accum_24hr'] = get_radar_colours()
