...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            db.State(valid_time=dt.datetime(2019, 1, 1)),
            True,
        ),
        (
            db.State(initial_time="2019-01-01 00:00:00"),
            db.State(initial_time=dt.datetime(2019, 1, 1)),
            True,
        ),
        (
            db.State(
            ...
            db.State(initial_times=["2019-01-01 00:00:00"]),
            True,
        ),
        (
        ...
        (
            ...
            db.State(valid_times=["2019-01-01 00:00:00"]),
            True,
        ),
        ...
        (
            ...
            db.State(pressures=[1000.0001, 900]),
            True,
        ),
        (
            db.State(pressures=[1000.001, 900]),
            db.State(pressures=[900, 900]),
            False,
        ),
